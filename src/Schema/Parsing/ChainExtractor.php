...
use Chr15k\SchemaAudit\Schema\ColumnCall;
use Chr15k\SchemaAudit\Schema\ColumnChain;
use PhpParser\Node;
...
final class ChainExtractor
{
    ...
    private function toColumnCall(MethodCall $node): ColumnCall
    {
        ...
        return new ColumnCall(method: $methodName, stringArgs: $stringArgs, arrayArgs: $arrayArgs);
    }
}
